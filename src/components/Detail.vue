<template>
  <div class="detail">
    ...
    <div class="content">
      <div class="header clear"><h2><img src="../assets/img/i6.png" alt=""/></h2><p>张德帅{{$route.params.id}}</p></div>
      <div class="cont">
        <h3>为何长的如此之帅</h3>
        <div class="time"><p>2019年3月29日 11:14:58 <span><img src="../assets/img/zan.png" alt=""/></span></p></div>
        <div class="text-box">我也不知道</div>
      </div>
    </div>
    <div class="foot-btn">
      <ul>
